...
import { Home, Truck, FlaskConical, Thermometer, Settings, LogOut } from 'lucide-react';
...
const Sidebar = () => {
    ...
    const navGroups = [
        {
            title: 'Main',
            items: [
                { path: '/qc/home', icon: Home, label: 'Home' },
            ]
        },
        {
            title: 'Operations',
    ...
    return (
        <aside className="fixed left-[10px] top-[84px] bottom-[10px] w-[260px] bg-green-50 dark:bg-[#1F2937] border border-green-100 dark:border-gray-700 rounded-2xl shadow-xl z-30 flex flex-col transition-colors duration-300">
